...
public struct PosPackage : IFlatbufferObject
{
  ...
  public static Offset<responses.PosPackage> CreatePosPackage(FlatBufferBuilder builder, uint Id, float X, float Y) {
    builder.Prep(4, 12);
    builder.PutFloat(Y);
    builder.PutFloat(X);
    builder.PutUint(Id);
    return new Offset<responses.PosPackage>(builder.Offset);
  }
};
