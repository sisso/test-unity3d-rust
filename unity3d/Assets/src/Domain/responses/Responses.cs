...
public struct Responses : IFlatbufferObject
{
  ...
  public responses.EmptyPackage? Simple(int j) { int o = __p.__offset(4); return o != 0 ? (responses.EmptyPackage?)(new responses.EmptyPackage()).__assign(__p.__vector(o) + j * 2, __p.bb) : null; }
  public int SimpleLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }
  public responses.CreatePackage? CreateObject(int j) { int o = __p.__offset(6); return o != 0 ? (responses.CreatePackage?)(new responses.CreatePackage()).__assign(__p.__vector(o) + j * 16, __p.bb) : null; }
  public int CreateObjectLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
  public responses.PosPackage? MoveObj(int j) { int o = __p.__offset(8); return o != 0 ? (responses.PosPackage?)(new responses.PosPackage()).__assign(__p.__vector(o) + j * 12, __p.bb) : null; }
  public int MoveObjLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<responses.Responses> CreateResponses(FlatBufferBuilder builder,
  ...
  public static Offset<responses.Responses> EndResponses(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<responses.Responses>(o);
  }
};
