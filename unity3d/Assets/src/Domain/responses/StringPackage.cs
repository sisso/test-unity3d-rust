...
public struct StringPackage : IFlatbufferObject
{
  ...
  public static Offset<responses.StringPackage> CreateStringPackage(FlatBufferBuilder builder,
  ...
  public static Offset<responses.StringPackage> EndStringPackage(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<responses.StringPackage>(o);
  }
};
