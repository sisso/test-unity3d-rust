...
public struct BytesPackage : IFlatbufferObject
{
  ...
  public static Offset<responses.BytesPackage> CreateBytesPackage(FlatBufferBuilder builder,
  ...
  public static Offset<responses.BytesPackage> EndBytesPackage(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<responses.BytesPackage>(o);
  }
};
