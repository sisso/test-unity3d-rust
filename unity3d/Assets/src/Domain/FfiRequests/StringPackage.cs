...
public struct StringPackage : IFlatbufferObject
{
  ...
  public FfiRequests.RequestKind Kind { get { int o = __p.__offset(4); return o != 0 ? (FfiRequests.RequestKind)__p.bb.GetUshort(o + __p.bb_pos) : FfiRequests.RequestKind.GameStatus; } }
