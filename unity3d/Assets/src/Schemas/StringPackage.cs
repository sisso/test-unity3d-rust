...
public struct StringPackage : IFlatbufferObject
{
  ...
  public static Offset<StringPackage> CreateStringPackage(FlatBufferBuilder builder,
  ...
  public static Offset<StringPackage> EndStringPackage(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<StringPackage>(o);
  }
};
