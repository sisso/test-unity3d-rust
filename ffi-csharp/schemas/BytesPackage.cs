...
public struct BytesPackage : IFlatbufferObject
{
  ...
  public static Offset<BytesPackage> CreateBytesPackage(FlatBufferBuilder builder,
  ...
  public static Offset<BytesPackage> EndBytesPackage(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<BytesPackage>(o);
  }
};
